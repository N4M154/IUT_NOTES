...
.data
    prompt db 'Input: $'
    output db 13,10,'Prime Digits Descending: $'
...
not_prime:
    ...
    ; Bubble sort primes in DESCENDING order
    mov cl, prime_count
...
inner_loop:
    ...
    mov dl, [si+1]
    cmp al, dl
    jge no_swap          ; If already in descending order, skip swap
...
display_primes:
    ...
    ; Display sorted prime numbers in descending order
    mov cl, prime_count
    mov ch, 0
    mov si, offset primes
