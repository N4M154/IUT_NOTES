...
convert_loop:
    ...
    cmp al, 'A'         ; Check if >= 'A'
    jb store_char       ; If not uppercase, store as is
    cmp al, 'Z'         ; Check if <= 'Z'
    ja store_char       ; If not uppercase, store as is
    add al, 32          ; Convert to lowercase (add 32)
...
store_char:
    ...
    ; Display reversed lowercase string
    mov ah, 09h
    lea dx, output_str
    int 21h
