...
namespace AirlineReservationSystem
{
    public abstract class FlightDistance
    {
        ...
        public void DisplayMeasurementInstructions()
        {
            string symbols = "+---------------------------+";
            Console.WriteLine($"\n\n {symbols,100}");
            Console.WriteLine($" {"| SOME IMPORTANT GUIDELINES |",100}");
            Console.WriteLine($" {symbols,100}");

            Console.WriteLine("\n\t\t1. Distance between the destinations are based upon the Airports Coordinates (Latitudes & Longitudes) based in those cities\n");
            Console.WriteLine("\t\t2. Actual Distance of the flight may vary from this approximation as Airlines may define their own travel policy that may restrict the planes to fly through specific regions...\n");
